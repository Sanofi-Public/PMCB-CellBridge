...
## Visualization of Merged scRNA-Seq Object in 2D Space {.tabset}
...
if (opt$genesets != "none") {
  ...
  # ===================================
  xsobj <- fsobj
  xsobj$temp <- xsobj$sargent_cellstates
  ...
  for (cltype in sort(names(gene.sets))) {
    ...
    cells <- Cells(fsobj)[grepl(paste0("^", childs, collapse="|"), fsobj$sargent_cellstates)]
