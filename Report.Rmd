...
### Summary of the data after quality filters
...
### QC results by dimension reduction {.tabset .tabset-fade .tabset-dropdown}
...
### Clusters distribution per `r paste(vars, collapse=' and ')` {.tabset}
...
### Celltypes dimension reduction {.tabset .tabset-fade .tabset-dropdown}
...
`r if (opt$genesets != "none") { "### Sargent marker expression {.tabset .tabset-fade .tabset-dropdown}" }`
